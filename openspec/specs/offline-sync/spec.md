...
## Purpose
Registro de extracciones sin conexión mediante una cola local en IndexedDB con ids UUID de cliente, sincronización automática e idempotente al recuperar la red y visibilidad de los pendientes en el Diario.
