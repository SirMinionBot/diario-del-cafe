...
## Purpose
Asistente de dial-in: motor de reglas determinista y puro que, a partir del tiempo y el sabor del shot, sugiere un único ajuste con explicación y tono orientativo.
