...
## Purpose
Exportación de los datos del usuario como backup JSON versionado y como CSV de extracciones, e importación del backup propio con validación estructural, remapeo de ids y modo de reemplazo opcional con confirmación explícita.
