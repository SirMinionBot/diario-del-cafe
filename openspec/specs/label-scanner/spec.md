...
## Purpose
Escaneo de etiquetas de café con OCR ejecutado íntegramente en el dispositivo, extracción estructurada de campos (tostador, origen, fecha de tueste) para prerellenar formularios editables y matching contra el catálogo propio del usuario.
